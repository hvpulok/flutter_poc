        ...
        Expanded(
          child: ListView(
            children: <Widget>[
              ...
              CompassToggler(
                  textMessage:
                      '${_compassEnabled ? 'disable' : 'enable'} compass',
                  onPress: () {
                    setState(() {
...
class CompassToggler extends StatelessWidget {
  final String textMessage;
  final Function onPress;
  CompassToggler({Key key, this.textMessage, this.onPress}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return FlatButton(child: Text(textMessage), onPressed: onPress);
  }
}
